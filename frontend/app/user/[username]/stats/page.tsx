    ...
    case "spotify":
      return (
        <svg
          viewBox="0 0 24 24"
          fill="#1DB954"
          className="w-4 h-4 shrink-0 shadow-[0_0_5px_rgba(29,185,84,0.5)] rounded-full"
        >
