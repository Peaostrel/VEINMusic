  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <p className="text-xs text-gray-400 mb-4 leading-relaxed">
        Настройте свои музыкальные редкости с оценками и мини-обзорами. Они будут отображаться в красивой секции на вашей публичной странице.
      </p>

      <div className="bg-[#121212]/50 p-5 rounded-xl border border-white/5 space-y-6">
        {/* АРТИСТ */}
        <div className="space-y-3">
          <label htmlFor="fav-artist" className="block text-sm font-bold text-gray-300">
            🎤 Любимый артист
          </label>
          <input
            id="fav-artist"
          ...
          <div className="grid grid-cols-1 gap-3 pt-2">
            <div>
              <span className="block text-xs font-bold text-gray-400 mb-1">Оценка артиста</span>
              <StarRating
            ...
            <div>
              <label htmlFor="fav-artist-review" className="block text-xs font-bold text-gray-400 mb-1">
        ...
        <div className="pt-6 border-t border-white/5 space-y-3">
          <label htmlFor="fav-track-name" className="block text-sm font-bold text-gray-300">
            🎵 Любимый трек
          </label>
          ...
          <div className="grid grid-cols-1 gap-3 pt-2">
            <div>
              <span className="block text-xs font-bold text-gray-400 mb-1">Оценка трека</span>
              <StarRating
            ...
            <div>
              <label htmlFor="fav-track-review" className="block text-xs font-bold text-gray-400 mb-1">
        ...
        {/* АЛЬБОМ */}
        <div className="pt-6 border-t border-white/5 space-y-3">
          <label htmlFor="fav-album-name" className="block text-sm font-bold text-gray-300">
            💿 Любимый альбом
          </label>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
          ...
          <div className="grid grid-cols-1 gap-3 pt-2">
            <div>
              <span className="block text-xs font-bold text-gray-400 mb-1">Оценка альбома</span>
              <StarRating
            ...
            <div>
              <label htmlFor="fav-album-review" className="block text-xs font-bold text-gray-400 mb-1">
