  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-lg text-white">Spotify Cloud</h3>
                {userProfile?.spotify_linked && (
                  <span className="bg-[#1DB954]/20 text-[#1DB954] text-[10px] px-2 py-0.5 rounded font-bold border border-[#1DB954]/30">
                    ACTIVE
                  </span>
                )}
              </div>
              <p className="text-sm text-gray-400">
                Скробблинг напрямую через сервер.
              </p>
            </div>
          </div>
          <div className="flex gap-2">
            {userProfile?.spotify_linked && (
              <button
                ...
                className="bg-red-900/20 text-red-400 border border-red-900/30 font-bold px-4 py-2 rounded-xl text-sm"
              >
                Отключить
              </button>
            )}
            <button
              ...
              className="bg-[#1DB954] text-black font-black px-6 py-2 rounded-xl text-sm hover:scale-105 transition-all"
            >
              🔗 {userProfile?.spotify_linked ? "Обновить" : "Привязать"}
            </button>
          </div>
        </div>
      ...
      <div className="bg-[#121212]/50 p-6 rounded-xl border border-white/5 flex flex-col gap-4 relative overflow-hidden shadow-md">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#ffcc00] rounded-xl flex items-center justify-center text-black font-black text-xl">
              Y
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-bold text-lg text-white">Yandex Cloud</h3>
                {userProfile?.yandex_linked && (
                  <span className="bg-[#ffcc00]/20 text-[#ffcc00] text-[10px] px-2 py-0.5 rounded font-bold border border-[#ffcc00]/30">
                    ACTIVE
                  </span>
                )}
              </div>
            ...
            <div className="flex gap-2">
              {userProfile?.yandex_linked && (
                <button
                  ...
                  className="flex-1 bg-red-900/20 text-red-400 border border-red-900/30 font-bold py-2 rounded-lg text-xs"
                >
                  Удалить
                </button>
              )}
              <button
                ...
                className="flex-1 bg-[#ffcc00] text-black font-bold py-2 rounded-lg text-xs"
              >
                Сохранить
              </button>
            </div>
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <svg
              viewBox="0 0 24 24"
              fill="#D51007"
              className="w-12 h-12 shrink-0 drop-shadow-[0_0_8px_rgba(213,16,7,0.4)]"
