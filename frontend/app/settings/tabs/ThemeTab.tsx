...
const FRAMES = [
  ...
  { id: 'audiophile', name: 'Аудиофил', req: 15, class: 'avatar-frame-audiophile' },
  ...
  return (
    <div className="p-6 md:p-8 space-y-8">
      ...
      <div className="pt-6 border-t border-white/5">
        <h2 className="text-xl font-bold mb-2 text-[var(--accent-text)]">Анимированная рамка аватара</h2>
        <p className="text-xs text-gray-400 mb-6 leading-relaxed">
          Украсьте ваш аватар уникальной анимированной рамкой. Дополнительные стили разблокируются по мере роста вашего уровня.
        </p>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-gray-400">LVL {frame.req}</div>
                  </div>
                </div>
                <div>
                  {frameStatusIndicator}
